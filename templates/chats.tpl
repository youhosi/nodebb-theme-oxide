<div class="chats-full">
	<div component="chat/nav-wrapper" data-loaded="<!-- IF roomId -->1<!-- ELSE -->0<!-- END -->">
		<div class="chat-search dropdown">
			<label class="search-input" id="icon-search">
				<input autocomplete="off" class="form-control search-input" type="text" component="chat/search" placeholder="[[users:enter_username]]" data-toggle="dropdown"/>
			</label>
